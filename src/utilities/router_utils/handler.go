...
// HandlerFunc is what handles the requests. It returns the response code and the data we are sending
type HandlerFunc func(http.ResponseWriter, *http.Request) (int, interface{})

type middleware func(http.ResponseWriter, *http.Request) (int, interface{})
